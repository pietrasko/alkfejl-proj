...
insert into reg(name, code) values('QP', 'AAAAAAAAAAA');
insert into reg(name, code) values('PQ', 'BBBBBBBBBBB');
insert into reg(name, code) values('Q', 'CCCCCCCCCCC');
...
insert into task(admin_id, user_id, completed, completion_confirmed, task_description, deadline) values(1,3,false, false, 'meg kell csinalni', current_timestamp);
insert into task(admin_id, user_id, completed, completion_confirmed, task_description, deadline) values(2,2,false, false, 'Bela  csinalnd mög', current_timestamp);